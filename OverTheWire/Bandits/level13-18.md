...
Goal: connect to server using SLL encryption
...
Goal: search for open port with `nmap`
...
1. search for open port in range 31000-32000
...
By entering last password, we get RSA private key
...
Flag: RSA private key (bandit16_key)


### Level 17 -> Level 18


Goal: Compare files with command `diff`


```
>>> chmod 700 bandit16_key
...
Goal: execute command after ssh 
